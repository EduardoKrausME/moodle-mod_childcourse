...
$string['report_activitycompletion'] = 'Activity completion';
$string['report_activitygrade'] = 'Activity grade';
$string['report_completed'] = 'Completed';
$string['report_completionratio'] = '{$a->completed}/{$a->total} tracked activities completed';
$string['report_completionstatus'] = 'Completion check';
$string['report_gradestatus'] = 'Grade check';
$string['report_incomplete'] = 'Incomplete';
$string['report_nograde'] = 'No grade';
$string['report_remotecompletion'] = 'Child course completion';
$string['report_remotegrade'] = 'Child course grade';
$string['report_status_discrepant'] = 'Discrepant';
$string['report_status_ok'] = 'OK';
$string['reporttitle'] = 'Sync report';
